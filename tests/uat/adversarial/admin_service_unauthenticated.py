"""
module_id: tests.uat.adversarial.admin_service_unauthenticated
file: tests/uat/adversarial/admin_service_unauthenticated.py
task_id: T-1302
"""
...
SCENARIO = "admin_service_unauthenticated"
