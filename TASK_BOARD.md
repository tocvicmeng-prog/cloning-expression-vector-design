...
**Last updated:** 2026-05-14 (Residual risk register refreshed: R-04, R-07, R-13, R-14, and R-15 are now implemented/verified; catalogue, rule, and manifest governance gates promoted to enforced CI mode; SBOL exact-range feature coordinates round-trip locally).
