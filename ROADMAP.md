...
**Status:** Phase 0 + Phase 1 + Phase 2 + Phase 3 + Phase 4 + Phase 5 + Phase 6 complete locally, and Phase 7 is complete locally through T-703. T-703 delivered the pure `engine.assembly` package with strategy contracts and typed plan compilers for restriction ligation, Gibson-like assembly, Golden Gate kits, Gateway, LIC, SLIC, USER, IVA, and yeast TAR. T-704 `engine.primer` is the next hand-off.
