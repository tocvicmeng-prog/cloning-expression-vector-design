...
**Status:** Phase 0 + Phase 1 + Phase 2 + Phase 3 + Phase 4 + Phase 5 + Phase 6 + Phase 7 complete locally. T-705 delivered the `app.assembly_orchestrator` fixed-point loop over codon optimisation, validation hooks, assembly planning, and primer design with a five-iteration cap and structured convergence failure. T-801 `engine.risk_classification` is the next hand-off.
