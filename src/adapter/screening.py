...
file: src/adapter/screening.py
task_id: T-203

Public API placeholder for adapter.screening. The owning implementation task is T-1002.
"""
...
def module_not_implemented() -> NoReturn:
    """Raise until adapter.screening's public API is implemented by its owning task."""
